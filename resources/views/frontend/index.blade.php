...
<section class="intro-section">
  <div class="owl-carousel owl-theme row owl-dot-inner owl-dot-white intro-slider animation-slider cols-1 gutter-no"
    ...
    <div class="banner banner-fixed intro-slide1" style="background-color: #46b2e8">
      <figure>
        <img src="{{ asset('frontend/images/demos/demo1/slides/slide1.jpg')}}" alt="intro-banner" width="1903" height="630" style="background-color: #34ace5"/>
      </figure>
      <div class="container">
        ...
        <div class="banner-content y-50 ml-auto text-right">
          ...
          >
            <span class="d-block text-uppercase mb-2"
              >Coming soon</span
            ><strong class="font-weight-semi-bold ls-m"
              >Riode Birthday</strong
            >
          </h4>
          <h2
            class="
          ...
          >
            Up to 70% off on all products <br />online &amp; Free
            Shipping over $90
          </p>
          <a
            href="shop.html"
    ...
    >
      ...
      <div class="container">
        <div class="banner-content x-50 y-50 text-center">
          ...
          >
            Up to 50% Off this Season’s &amp; Get free shipping<br />on
            all orders over $199.00
          </p>
          <a
            href="shop.html"
...
<section class="pt-10 mt-7 appear-animate"
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="owl-carousel owl-theme row owl-nav-full cols-lg-4 cols-md-3 cols-sm-2 cols-1"
        data-owl-options="{
                  'nav': true,
                  'dots': false,
                  'items': 4,
  ...
  <div class=" owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5"
    ...
    <div class="product text-center">
      <figure class="product-media">
        <a href="product.html">
          <img
            src="{{ asset('frontend/images/demos/demo1/products/product5.jpg')}}"
    ...
    <div class="product text-center">
      <figure class="product-media">
        <a href="product.html">
          <img
            src="{{ asset('frontend/images/demos/demo1/products/product6.jpg')}}"
            alt="Blue Pinafore Denim Dress"
            width="220"
            height="245"
            style="background-color: #f2f3f5"
    ...
    <div class="product text-center">
      <figure class="product-media">
        <a href="product.html">
          <img
            src="{{ asset('frontend/images/demos/demo1/products/product7.jpg')}}"
            alt="Blue Pinafore Denim Dress"
            width="220"
            height="245"
            style="background-color: #f2f3f5"
    ...
    <div class="product text-center">
      <figure class="product-media">
        <a href="product.html">
          <img
            src="{{ asset('frontend/images/demos/demo1/products/product8.jpg')}}"
            alt="Blue Pinafore Denim Dress"
            width="220"
            height="245"
            style="background-color: #f2f3f5"
    ...
    <div class="product text-center">
      <figure class="product-media">
        <a href="product.html">
          <img
            src="{{ asset('frontend/images/demos/demo1/products/product9.jpg')}}"
            alt="Blue Pinafore Denim Dress"
            width="220"
            height="245"
            style="background-color: #f2f3f5"
...
<section class="pt-10 pb-10 parallax" data-image-src="{{ asset('frontend/images/banner.jpg')}}">
  <div class="container mt-4 mb-4">
    <div
      class="owl-carousel owl-theme row owl-dot-white cols-1"
      data-owl-options="{
                  'items': 1,
                  'nav': false,
                  'dots': true,
    ...
    >
      <div class="testimonial testimonial-centered testimonial-bg">
        <div class="testimonial-info">
          <figure class="testimonial-author-thumbnail">
            <img
              src="{{ asset('frontend/images/agents/4.jpg')}}"
              alt="user"
              width="50"
              height="50"
            />
          ...
          <blockquote>
            ...
            Pellentesque odio nisi, euismod in, pharetra ”
          </blockquote>
          <cite>
            Charly Simth
            <span>Customer</span>
      ...
      <div class="testimonial testimonial-centered testimonial-bg">
        <div class="testimonial-info">
          <figure class="testimonial-author-thumbnail">
            <img
              src="{{ asset('frontend/images/agents/5.jpg')}}"
              alt="user"
              width="50"
              height="50"
            />
      ...
      <div class="testimonial testimonial-centered testimonial-bg">
        <div class="testimonial-info">
          <figure class="testimonial-author-thumbnail">
            <img
              src="{{ asset('frontend/images/agents/2.jpg')}}"
              alt="user"
              width="50"
              height="50"
            />
        ...
        <article class="post post-frame overlay-zoom">
          <figure class="post-media">
            <a href="post-single.html">
              <img
                src="{{ asset('frontend/images/blog/frame/1.jpg')}}"
                alt="Blog post"
                width="340"
                height="206"
          ...
          <div class="post-details">
            <h4 class="post-title">
              <a href="post-single.html"
                >20% Off Coupon for Cyber Week</a
              >
            </h4>
      ...
      <div class="blog-post mb-4">
        <article class="post post-frame overlay-zoom">
          <figure class="post-media">
            <a href="post-single.html">
              <img
                src="{{ asset('frontend/images/blog/frame/2.jpg')}}"
                alt="Blog post"
                width="340"
                height="206"
      ...
      <div class="blog-post mb-4">
        <article class="post post-frame overlay-zoom">
          <figure class="post-media">
            <a href="post-single.html">
              <img
                src="{{ asset('frontend/images/blog/frame/3.jpg')}}"
                alt="Blog post"
                width="340"
                height="206"
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-sm-6 mb-4">
        <div class="widget widget-products appear-animate" data-animation-options="{'name': 'fadeInLeftShorter',
                          'delay': '.5s'
                      }">
          <h4 class="widget-title border-no lh-1 font-weight-bold">
            Sale Products
          </h4>
          <div class="products-col">
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product10.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product11.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product12.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
      ...
      <div class="col-lg-3 col-sm-6 mb-4">
        <div
          class="widget widget-products appear-animate"
          data-animation-options="{
          ...
          <div class="products-col">
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product13.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product14.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product15.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
          ...
          <div class="products-col">
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product16.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product17.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product18.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
          ...
          <div class="products-col">
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product19.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
              ...
              <div class="product-details">
                <h3 class="product-name">
                  <a href="product.html"
                    >Fashion Electric Wrist Watch</a
                  >
                </h3>
                <div class="product-price">
                  <span class="price">$270.99</span>
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product20.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
            ...
            <div class="product product-list-sm">
              <figure class="product-media">
                <a href="product.html">
                  <img
                    src="{{ asset('frontend/images/demos/demo1/products/product21.jpg')}}"
                    alt="product"
                    width="100"
                    height="114"
                    style="background-color: #f2f3f5"
