                                ...
                                <tbody>
                                    @forelse ($datas as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->preview_img == '')
                                                    <img width="40" src="{{ asset('default/categories/default.png') }}" class="rounded mr-3" alt="Flowerpot">
                                                @else
                                                    <img width="40" src="{{ asset('uploads/categories/image') }}/{{ $item->preview_img }}" class="rounded mr-3" alt="Flowerpot">
                                                @endif
                                            </td>

                                            <td> {{ $item->title }}</td>
                                            <td>
                                                @forelse ($item->subcategories as $subcategory)
                                                    {{ $subcategory->title }},
                                                @empty
                                                N\A
                                                @endforelse
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a href="{{ route('admin.categories.edit', $item->id) }}" class="dropdown-item">Edit</a>
